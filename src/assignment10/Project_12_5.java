...
public class Project_12_5 {
	
	 public static void main(String[] args) throws IOException {
		    int value, value2;
		    Project_12_5 heap1 = new Project_12_5();
		    Heap<DataItem> theHeap = heap1.new Heap<>();
		    boolean success;

		    theHeap.insert(70, heap1.new DataItem());
		    theHeap.insert(40, heap1.new DataItem());
		    theHeap.insert(50, heap1.new DataItem());
		    theHeap.insert(20, heap1.new DataItem());
		    theHeap.insert(60, heap1.new DataItem());
		    theHeap.insert(100, heap1.new DataItem());
		    theHeap.insert(80, heap1.new DataItem());
		    theHeap.insert(30, heap1.new DataItem());
		    theHeap.insert(10, heap1.new DataItem());
		    theHeap.insert(90, heap1.new DataItem());
		    ...
		    while (true) {
		      ...
		      switch (choice) {
		        ...
		        case 'i':
		          ...
		          value = getInt();
		          success = theHeap.insert(value, heap1.new DataItem());
		          if (!success)
	...
	class DataItem 
	{
	    ...
	    public void displayTree() {
	      ...
	      while (isRowEmpty == false) {
	        ...
	        while (globalStack.isEmpty() == false) {
	          Node<E> temp = (Node<E>) globalStack.pop();
	          if (temp != null) {
	  ...
	  class Heap<E> {
	    ...
	    public Node<E> remove() {
	      ...
	      System.out.println("The largest item is removed");
	      return removedRoot;
	    }
